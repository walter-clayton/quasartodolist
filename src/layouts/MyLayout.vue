<template>
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar class="bg-grey-10 q-mx-none">
        <q-btn class="q-m-none"
          flat
          dense
          round
      ...
      >
        ...
        <q-img class="absolute-top" src="https://images.unsplash.com/photo-1496964551482-5eef1122d121?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80" style="height: 150px">
          <div class="absolute-bottom bg-transparent">
            <q-avatar size="56px" class="q-mb-sm">
              <img src="https://cdn.quasar.dev/img/boy-avatar.png">
            </q-avatar>
            <div class="text-weight-bold">Walter Clayton</div>
            <div>@walthedude</div>
          </div>
        </q-img>
      </q-drawer>
